...
export default function IncomingCallModal() {
  ...
  // 2. Lắng nghe sự kiện Call Ended
  useEffect(() => {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-sm bg-gray-900 border border-white/10 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col items-center py-12 px-6">
        ...
        <div className="relative mb-8 mt-4">
            ...
            {/* Icon loại cuộc gọi nhỏ ở góc avatar */}
        ...
        <div className="flex items-center justify-between w-full px-4 z-10">
          ...
          <div className="flex flex-col items-center gap-2">
             <button
                onClick={rejectCall}
                className="group relative flex items-center justify-center w-16 h-16 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white rounded-full border border-red-500/30 transition-all duration-300 active:scale-95"
            >
                <PhoneOff size={28} />
             </button>
             <span className="text-xs text-gray-400 font-medium">Reject</span>
          </div>

          {/* Nút Nghe máy (Nổi bật hơn) */}
          <div className="flex flex-col items-center gap-2">
            <button
                onClick={handleAccept}
                className="group relative flex items-center justify-center w-20 h-20 bg-green-500 hover:bg-green-400 text-white rounded-full shadow-[0_0_20px_rgba(34,197,94,0.4)] hover:shadow-[0_0_30px_rgba(34,197,94,0.6)] transition-all duration-300 animate-bounce active:scale-95"
            >
